...
$("body").on("kaydenLoaded", function () {
    ...
    $(`a.kayden_scrollspy[href^="#"]:not([href="#"]`).on("click", function (c) {
        var b = $(this);
        var d = parseInt($("body").data("offset"));
        $("html, body").stop().animate({scrollTop: ($(b.attr("href")).offset().top) - (d - 1)}, 1500, "easeInOutExpo");
        c.preventDefault()
    });
