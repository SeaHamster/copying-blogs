...
!function (b) {
    ...
    var X, Z, ab, ad, af, ah, aj = "Close", al = "BeforeClose", an = "AfterClose", ap = "BeforeAppend",
        ar = "MarkupParse", au = "Open", aw = "Change", ay = "mfp", aA = "." + ay, aC = "mfp-ready",
        aE = "mfp-removing", aG = "mfp-prevent-close", aI = function () {
        }, aK = !!window.jQuery, aM = V(window), aN = function (b, d) {
            X.ev.on(ay + b + aA, d)
        }, aO = function (a, g, h, i) {
            ...
            var c = document.createElement("p").style, d = ["ms", "O", "Moz", "Webkit"];
    ...
    aI.prototype = {
        constructor: aI, init: function () {
            ...
            if (X.isIOS) {
                var e = document.documentElement.clientWidth / window.innerWidth, f = window.innerHeight * e;
            ...
            var b, h = X.items[a];
            if (h.tagName ? h = {el: V(h)} : (b = h.type, h = {data: h, src: h.src}), h.el) {
            ...
            if (!V(a).hasClass(aG)) {
                var b = X.st.closeOnContentClick, f = X.st.closeOnBgClick;
                if (b && f) {
                    return !0
                }
        ...
        if ("string" == typeof a) {
            if ("open" === a) {
                ...
                i.items ? h = i.items[j] : (h = b, i.delegate && (h = h.find(i.delegate)), h = h.eq(j)), X._openClick({mfpEl: h}, b, i)
            } else {
    ...
    V.magnificPopup.registerModule(am, {
        options: {
            ...
            initAjax: function () {
                ...
                var b = V.extend({
                    url: a.src, success: function (c, h, i) {
                        var j = {data: c, xhr: i};
    ...
    V.magnificPopup.registerModule("image", {
        options: {
            ...
            initImage: function () {
                ...
                var f = 0, g = b.img[0], h = function (a) {
    ...
    V.magnificPopup.registerModule("zoom", {
        options: {
            ...
            initZoom: function () {
                ...
                if (h.enabled && X.supportsTransition) {
                    var l, m, n = h.duration, o = function (c) {
                        var g = c.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                            j = "all " + h.duration / 1000 + "s " + h.easing, k = {
                                position: "fixed",
                                zIndex: 9999,
                                left: 0,
                                top: 0,
                ...
                var i = b.offset(), j = parseInt(b.css("padding-top"), 10), k = parseInt(b.css("padding-bottom"), 10);
                i.top -= V(window).scrollTop() - j;
                var l = {width: b.width(), height: (aK ? b.innerHeight() : b[0].offsetHeight) - k - j};
                return az() ? l["-moz-transform"] = l.transform = "translate(" + i.left + "px," + i.top + "px)" : (l.left = i.left, l.top = i.top), l
            }
        }
    });
    var aB = "iframe", aD = "//about:blank", aF = function (b) {
    ...
    V.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                var a = X.st.gallery, b = ".mfp-gallery";
        ...
        options: {
            ...
            initRetina: function () {
                if (window.devicePixelRatio > 1) {
                    var b = X.st.retina, d = b.ratio;
                    d = isNaN(d) ? d() : d, d > 1 && (aN("ImageHasSize." + aL, function (c, e) {
                        e.img.css({"max-width": e.img[0].naturalWidth / d, width: "100%"})
